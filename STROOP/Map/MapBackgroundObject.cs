...
namespace STROOP.Map
{
    public abstract class MapBackgroundObject : MapIconRectangleObject
    {
        ...
        {
            float xCenter = StroopMainForm.instance.mapTab.glControlMap2D.Width / 2;
            float yCenter = StroopMainForm.instance.mapTab.glControlMap2D.Height / 2;
            float length = Math.Max(StroopMainForm.instance.mapTab.glControlMap2D.Width, StroopMainForm.instance.mapTab.glControlMap2D.Height);
