...
namespace STROOP.Map
{
    public class MapGraphics
    {
        ...
        public float MapViewRadius { get => (float)MoreMath.GetHypotenuse(
            StroopMainForm.instance.mapTab.glControlMap2D.Width / 2, StroopMainForm.instance.mapTab.glControlMap2D.Height / 2) / MapViewScaleValue; }
        ...
        public void Load()
        {
            StroopMainForm.instance.mapTab.glControlMap2D.MakeCurrent();
            StroopMainForm.instance.mapTab.glControlMap2D.Context.LoadAll();

            StroopMainForm.instance.mapTab.glControlMap2D.Paint += (sender, e) => OnPaint();

            StroopMainForm.instance.mapTab.glControlMap2D.MouseDown += OnMouseDown;
            StroopMainForm.instance.mapTab.glControlMap2D.MouseUp += OnMouseUp;
            StroopMainForm.instance.mapTab.glControlMap2D.MouseMove += OnMouseMove;
            StroopMainForm.instance.mapTab.glControlMap2D.MouseWheel += OnScroll;
            StroopMainForm.instance.mapTab.glControlMap2D.DoubleClick += OnDoubleClick;
        ...
        private void OnPaint()
        {
            ...
            if (StroopMainForm.instance.mapTab.glControlMap2D.Cursor != cursor)
            {
                StroopMainForm.instance.mapTab.glControlMap2D.Cursor = cursor;
            }
            ...
            StroopMainForm.instance.mapTab.flowLayoutPanelMapTrackers.DrawOn2DControl();

            StroopMainForm.instance.mapTab.glControlMap2D.SwapBuffers();
        }

        private void UpdateViewport()
        {
            int w = StroopMainForm.instance.mapTab.glControlMap2D.Width;
            int h = StroopMainForm.instance.mapTab.glControlMap2D.Height;
            ...
            switch (MapViewScale)
            {
                ...
                case MapScale.MaxCourseSize:
                    ...
                    MapViewScaleValue = Math.Min(
                        StroopMainForm.instance.mapTab.glControlMap2D.Width / rotatedWidth, StroopMainForm.instance.mapTab.glControlMap2D.Height / rotatedHeight);
                    break;
