...
namespace STROOP.Tabs.MapTab
{
    public class Map3DCamera
    {
        ...
        public Map3DCamera(Map3DGraphics parent)
        {
            this.parent = parent;
            parent.OnSizeChanged += (sender, e) => UpdateProjection();
            UpdateProjection();
        }

        private void UpdateProjection()
        {
            _projection = Matrix4.CreatePerspectiveFieldOfView(FOV, parent.AspectRatio, 1.0f, 0x4000);
        }
